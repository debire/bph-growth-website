...
function ContactUs() {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-[#1a2332] px-8 py-46 rounded-b-[40px]">
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid grid-cols-2 gap-x-32 gap-y-12">
                        ...
                        <div>
                            ...
                            <p className="text-gray-700">[+234... available upon inquiry]</p>
                        </div>

                        {/* Address */}
                        <div>
                            <h3 className="text-xl font-bold mb-3">Address</h3>
                            <p className="text-gray-700">23, Durojaiye Street, Surulere, Lagos</p>
                        </div>
