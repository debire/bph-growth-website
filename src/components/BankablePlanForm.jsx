  ...
  return (
    <section id="consultation-form" className="py-12 lg:py-16 px-4 lg:px-8 bg-[#1a2332]">
      ...
      {showCalendly && (
        ...
        >
          <div 
            className="bg-white rounded-2xl w-full max-w-4xl h-[90vh] shadow-2xl overflow-hidden"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="bg-white border-b border-gray-200 p-4 flex items-center justify-between">
              <div>
                <h3 className="text-xl font-bold text-gray-900">Select Your Appointment</h3>
                <p className="text-sm text-gray-600 mt-1">Choose a date and time that works for you</p>
              </div>
              <button
                onClick={closeCalendly}
            ...
            <div className="h-[calc(100%-80px)]">
              <div 
                ...
                data-url="https://calendly.com/YOUR_CALENDLY_USERNAME/consultation?hide_gdpr_banner=1&primary_color=60a5fa"
